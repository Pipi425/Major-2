...
def SnowVillage(player, game_data):
    # ================= INIT =================
    if game_data.get("Scene_Back"):
        player.set_position(0, 400)
        game_data["Scene_Back"] = False
    else:
        player.set_position(1248, 288)
